...
constexpr char TRIGGER_KEY[]  = "TriggerKey";
...
{
    int key = settings.value(TRIGGER_KEY, QVariant(Qt::Key_unknown)).toInt();
...
{
    settings.setValue(TRIGGER_KEY, QVariant(key.toCombined()));
}
